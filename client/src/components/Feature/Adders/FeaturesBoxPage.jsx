...
const FeaturesBoxPage = ({ user }) => {
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 p-4 max-w-6xl mx-auto'>
            ...
            {box_print("Virtual Library", "A digital repository offering a wide range of books, journals, and study materials to support self-paced learning and research", "bg-red-200", "/library", (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
                </svg>
            ))}

            {box_print("Interview Experiences", "A platform for sharing real-life interview insights and experiences, providing valuable tips and guidance for job seekers", "bg-yellow-200", "/interviews", (
            ...
            {box_print("FundRaising", "A tool to connect users for initiating and supporting fundraising efforts, helping drive educational and social initiatives", "bg-green-200", "/fundrasing", (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{ fill: 'black' }}>
            ...
            {box_print("Room-Mate Finder", "An easy-to-use service to match students with compatible roommates based on preferences and living arrangements", "bg-blue-200", "/roomfinder", (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{ fill: 'black' }}>
            ...
            {box_print("Campus Events", "A comprehensive guide to the latest college happenings, keeping users informed about events and activities on campus", "bg-purple-200", "/events", (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{ fill: 'black' }}>
            ...
            {user && user.isTeacher && box_print("Approve/Reject Book", "A moderation feature that allows educators to review and control book submissions, ensuring quality content in the library", "bg-pink-200", "/bookstatus", (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
